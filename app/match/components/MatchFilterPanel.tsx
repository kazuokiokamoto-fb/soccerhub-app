...
const stickyHeaderLeft: React.CSSProperties = {
  display: "grid",
  gap: 8,
};
...
const bottomStickyAction: React.CSSProperties = {
  position: "sticky",
  bottom: 0,
  zIndex: 15,
  background:
    "linear-gradient(180deg, rgba(247,251,248,0) 0%, rgba(247,251,248,0.94) 18%, rgba(247,251,248,1) 100%)",
  paddingTop: 8,
  paddingBottom: 4,
};
