...
import {
  ...
  Toast,
  STRENGTH_GUIDES,
} from "../../teams/search/components/teamSearchUtils";
...
import {
  ...
  guideBulletMark,
  guideNote,
} from "../../teams/search/components/teamSearchStyles";
...
export default function TeamsSearchClient() {
  ...
  const filteredTeams = useMemo(() => {
    return teams.filter((team: DbTeam) => {
      ...
      {showStrengthHelp ? (
        ...
        >
          <div style={modalCard} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={guideList}>
              {STRENGTH_GUIDES.map(
                (item: (typeof STRENGTH_GUIDES)[number]) => (
